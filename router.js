...
router.get("/top.pwa", csrfProtection, function (req, res) {
  res.sendFile("top.pwa.html", { root: __dirname + "/public/" });
});
router.get("/13update.pwa", csrfProtection, function (req, res) {
  res.sendFile("13update.pwa.html", { root: __dirname + "/public/" });
});
router.get("/about.pwa", csrfProtection, function (req, res) {
  res.sendFile("about.pwa.html", { root: __dirname + "/public/" });
});
router.get("/pwa.top", csrfProtection, function (req, res) {
  res.sendFile("pwa.top.html", { root: __dirname + "/public/" });
});
router.get("/failed", csrfProtection, function (req, res) {
  res.sendFile("failed.html", { root: __dirname + "/public/" });
});
